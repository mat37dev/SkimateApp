...
import { Animated, StyleSheet, StyleProp, ViewStyle, Platform, TouchableOpacity, View, Image, ImageSourcePropType } from "react-native";
	...
	return (
		<Animated.View style={[styles.header, { backgroundColor: bgColor, height: headerHeight }]}>
			...
			<View style={styles.titleContainer}>
				...
				<Animated.Text style={[styles.title, { color: textColor, fontSize: titleFontSize }]}>{title}</Animated.Text>
			</View>
		</Animated.View>
	);
}
